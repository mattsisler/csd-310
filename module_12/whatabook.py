...
# Define function called show_menu. Displays Main Menu to user.
def show_menu():
    print("\n  -- Main Menu --")
...
# Define function called show_books. Displays Books to user.
...
# Define function called show_locations. Displays store locations to user.
...
# Define function to display account of user
...
# Define function to show wish list of user
...
# Define function to display books that users can add to wishlist
...
# Define function to add book to users wish lists
    ...
    while user_selection != 4:
        ...
        if user_selection == 3:
            ...
            while account_option != 3:
                ...
                # isplay an invalid option if wrong choice is made 
        ...
        # display an invalid option if wrong choice is made
